"""Langchain nodes for RAG workflow + React Agent inside generate_content"""
...
class RAGNode:
    ...
    wikipedia_tool = Tool(
        name = "wikipedia",
        desciption = "Search Wikipedia for general knowledge",
        func = wiki.run,
    )
    ...
    def generate_answer(self, state: RAGState) -> RAGState:
        ...
        return RAGState(
            question = state.question
            retreived_docs = state.retrieve_docs,
