"""Langgraph nodes for RAG overflow"""
...
class RAGNodes:
    ...
    def retrieve_docs(self, state:RAGState) -> RAGState:
        ...
        docs = self.retreiver.invoke(state.question)
        return RAGState(
    ...
    def generate_answer(self, state: RAGState) -> RAGState:
        ...
        # Combine retrived documents into context
        context = "\n\n".join([doc.page_content for doc in state.retreived_docs])
        ...
        return RAGState(
            question = state.question,
            retreived_docs = state.retreived_docs,
